...
public class XmlToJson {
    ...
    private XmlToJson(Builder builder) {
        ...
        mInputEncoding = DEFAULT_ENCODING;
        mForceListPaths = new HashSet<>();
        mAttributeNameReplacements = new HashMap<>();
        mContentNameReplacements = new HashMap<>(); // Integer, Long, Double, Boolean
        mForceClassForPath = new HashMap<>();
        mSkippedAttributes = new HashSet<>();
        mSkippedTags = new HashSet<>();
